...
extension ViewController: MPPBIrisDelegate {
    func irisTracker(_ irisTracker: MPPBIris, didOutputTransform transform: simd_float4x4) {
    ...
    func irisTracker(_ irisTracker: MPPBIris, didOutputPixelBuffer pixelBuffer: CVPixelBuffer) {
